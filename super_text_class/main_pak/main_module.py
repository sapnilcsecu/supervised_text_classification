...
def main():
   ...
   """
    ...
    accuracy = Classifier().train_model(naive_bayes.MultinomialNB(),model_input.get_train_input(), model_input.get_test_input(), model_input.get_train_target(),model_input.get_test_target(),model_input.gettfidf_vect())
